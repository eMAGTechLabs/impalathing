...
func (p *TColumn) ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.BoolColumn = append(p.BoolColumn, _elem10)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *TColumn) ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.ByteColumn = append(p.ByteColumn, _elem11)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *TColumn) ReadField3(ctx context.Context, iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.I16Column = append(p.I16Column, _elem12)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *TColumn) ReadField4(ctx context.Context, iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.I32Column = append(p.I32Column, _elem13)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *TColumn) ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.I64Column = append(p.I64Column, _elem14)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *TColumn) ReadField7(ctx context.Context, iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		_elem16 := &TStringValue{}
		if err := _elem16.Read(ctx, iprot); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem16), err)
		}
		p.StringColumn = append(p.StringColumn, _elem16)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *TColumn) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetBoolColumn() {
		if err := oprot.WriteFieldBegin(ctx, "boolColumn", thrift.LIST, 1); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:boolColumn: ", p), err)
		}
		if err := oprot.WriteListBegin(ctx, thrift.STRUCT, len(p.BoolColumn)); err != nil {
			return thrift.PrependError("error writing list begin: ", err)
		}
...
func (p *TColumn) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetByteColumn() {
		if err := oprot.WriteFieldBegin(ctx, "byteColumn", thrift.LIST, 2); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:byteColumn: ", p), err)
		}
		if err := oprot.WriteListBegin(ctx, thrift.STRUCT, len(p.ByteColumn)); err != nil {
			return thrift.PrependError("error writing list begin: ", err)
		}
...
func (p *TColumn) writeField3(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetI16Column() {
		if err := oprot.WriteFieldBegin(ctx, "i16Column", thrift.LIST, 3); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:i16Column: ", p), err)
		}
		if err := oprot.WriteListBegin(ctx, thrift.STRUCT, len(p.I16Column)); err != nil {
			return thrift.PrependError("error writing list begin: ", err)
		}
...
func (p *TColumn) writeField4(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetI32Column() {
		if err := oprot.WriteFieldBegin(ctx, "i32Column", thrift.LIST, 4); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:i32Column: ", p), err)
		}
		if err := oprot.WriteListBegin(ctx, thrift.STRUCT, len(p.I32Column)); err != nil {
			return thrift.PrependError("error writing list begin: ", err)
		}
...
func (p *TColumn) writeField5(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetI64Column() {
		if err := oprot.WriteFieldBegin(ctx, "i64Column", thrift.LIST, 5); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:i64Column: ", p), err)
		}
		if err := oprot.WriteListBegin(ctx, thrift.STRUCT, len(p.I64Column)); err != nil {
			return thrift.PrependError("error writing list begin: ", err)
		}
...
func (p *TColumn) writeField6(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetDoubleColumn() {
		if err := oprot.WriteFieldBegin(ctx, "doubleColumn", thrift.LIST, 6); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:doubleColumn: ", p), err)
		}
		if err := oprot.WriteListBegin(ctx, thrift.STRUCT, len(p.DoubleColumn)); err != nil {
			return thrift.PrependError("error writing list begin: ", err)
		}
...
func (p *TColumn) writeField7(ctx context.Context, oprot thrift.TProtocol) (err error) {
	if p.IsSetStringColumn() {
		if err := oprot.WriteFieldBegin(ctx, "stringColumn", thrift.LIST, 7); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 7:stringColumn: ", p), err)
		}
		if err := oprot.WriteListBegin(ctx, thrift.STRUCT, len(p.StringColumn)); err != nil {
			return thrift.PrependError("error writing list begin: ", err)
		}
...
func (p *TColumn) Equals(other *TColumn) bool {
	...
	if len(p.BoolColumn) != len(other.BoolColumn) {
		return false
	}
	for i, _tgt := range p.BoolColumn {
		_src17 := other.BoolColumn[i]
		if !_tgt.Equals(_src17) {
			return false
		}
	}
	if len(p.ByteColumn) != len(other.ByteColumn) {
		return false
	}
	for i, _tgt := range p.ByteColumn {
		_src18 := other.ByteColumn[i]
		if !_tgt.Equals(_src18) {
			return false
		}
	}
	if len(p.I16Column) != len(other.I16Column) {
		return false
	}
	for i, _tgt := range p.I16Column {
		_src19 := other.I16Column[i]
		if !_tgt.Equals(_src19) {
			return false
		}
	}
	if len(p.I32Column) != len(other.I32Column) {
		return false
	}
	for i, _tgt := range p.I32Column {
		_src20 := other.I32Column[i]
		if !_tgt.Equals(_src20) {
			return false
		}
	}
	if len(p.I64Column) != len(other.I64Column) {
		return false
	}
	for i, _tgt := range p.I64Column {
		_src21 := other.I64Column[i]
		if !_tgt.Equals(_src21) {
			return false
		}
	}
	if len(p.DoubleColumn) != len(other.DoubleColumn) {
		return false
	}
	for i, _tgt := range p.DoubleColumn {
		_src22 := other.DoubleColumn[i]
		if !_tgt.Equals(_src22) {
			return false
		}
	}
	if len(p.StringColumn) != len(other.StringColumn) {
		return false
	}
	for i, _tgt := range p.StringColumn {
		_src23 := other.StringColumn[i]
...
func (p *TRow) ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.ColVals = append(p.ColVals, _elem24)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *TStatus) ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.InfoMessages = append(p.InfoMessages, _elem30)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *TGetTablesReq) ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.TableTypes = append(p.TableTypes, _elem41)
	}
	if err := iprot.ReadListEnd(ctx); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *TCLIServiceClient) OpenSession(ctx context.Context, req *TOpenSessionReq) (_r *TOpenSessionResp, _err error) {
	var _args43 TCLIServiceOpenSessionArgs
	_args43.Req = req
	var _result45 TCLIServiceOpenSessionResult
	var _meta44 thrift.ResponseMeta
	_meta44, _err = p.Client_().Call(ctx, "OpenSession", &_args43, &_result45)
...
func (p *TCLIServiceClient) CloseSession(ctx context.Context, req *TCloseSessionReq) (_r *TCloseSessionResp, _err error) {
	var _args46 TCLIServiceCloseSessionArgs
	_args46.Req = req
	var _result48 TCLIServiceCloseSessionResult
	var _meta47 thrift.ResponseMeta
	_meta47, _err = p.Client_().Call(ctx, "CloseSession", &_args46, &_result48)
...
func (p *TCLIServiceClient) GetInfo(ctx context.Context, req *TGetInfoReq) (_r *TGetInfoResp, _err error) {
	var _args49 TCLIServiceGetInfoArgs
	_args49.Req = req
	var _result51 TCLIServiceGetInfoResult
	var _meta50 thrift.ResponseMeta
	_meta50, _err = p.Client_().Call(ctx, "GetInfo", &_args49, &_result51)
...
func (p *TCLIServiceClient) ExecuteStatement(ctx context.Context, req *TExecuteStatementReq) (_r *TExecuteStatementResp, _err error) {
	var _args52 TCLIServiceExecuteStatementArgs
	_args52.Req = req
	var _result54 TCLIServiceExecuteStatementResult
	var _meta53 thrift.ResponseMeta
	_meta53, _err = p.Client_().Call(ctx, "ExecuteStatement", &_args52, &_result54)
...
func (p *TCLIServiceClient) GetTypeInfo(ctx context.Context, req *TGetTypeInfoReq) (_r *TGetTypeInfoResp, _err error) {
	var _args55 TCLIServiceGetTypeInfoArgs
	_args55.Req = req
	var _result57 TCLIServiceGetTypeInfoResult
	var _meta56 thrift.ResponseMeta
	_meta56, _err = p.Client_().Call(ctx, "GetTypeInfo", &_args55, &_result57)
...
func (p *TCLIServiceClient) GetCatalogs(ctx context.Context, req *TGetCatalogsReq) (_r *TGetCatalogsResp, _err error) {
	var _args58 TCLIServiceGetCatalogsArgs
	_args58.Req = req
	var _result60 TCLIServiceGetCatalogsResult
	var _meta59 thrift.ResponseMeta
	_meta59, _err = p.Client_().Call(ctx, "GetCatalogs", &_args58, &_result60)
...
func (p *TCLIServiceClient) GetSchemas(ctx context.Context, req *TGetSchemasReq) (_r *TGetSchemasResp, _err error) {
	var _args61 TCLIServiceGetSchemasArgs
	_args61.Req = req
	var _result63 TCLIServiceGetSchemasResult
	var _meta62 thrift.ResponseMeta
	_meta62, _err = p.Client_().Call(ctx, "GetSchemas", &_args61, &_result63)
...
func (p *TCLIServiceClient) GetTables(ctx context.Context, req *TGetTablesReq) (_r *TGetTablesResp, _err error) {
	var _args64 TCLIServiceGetTablesArgs
	_args64.Req = req
	var _result66 TCLIServiceGetTablesResult
	var _meta65 thrift.ResponseMeta
	_meta65, _err = p.Client_().Call(ctx, "GetTables", &_args64, &_result66)
...
func (p *TCLIServiceClient) GetTableTypes(ctx context.Context, req *TGetTableTypesReq) (_r *TGetTableTypesResp, _err error) {
	var _args67 TCLIServiceGetTableTypesArgs
	_args67.Req = req
	var _result69 TCLIServiceGetTableTypesResult
	var _meta68 thrift.ResponseMeta
	_meta68, _err = p.Client_().Call(ctx, "GetTableTypes", &_args67, &_result69)
...
func (p *TCLIServiceClient) GetColumns(ctx context.Context, req *TGetColumnsReq) (_r *TGetColumnsResp, _err error) {
	var _args70 TCLIServiceGetColumnsArgs
	_args70.Req = req
	var _result72 TCLIServiceGetColumnsResult
	var _meta71 thrift.ResponseMeta
	_meta71, _err = p.Client_().Call(ctx, "GetColumns", &_args70, &_result72)
...
func (p *TCLIServiceClient) GetFunctions(ctx context.Context, req *TGetFunctionsReq) (_r *TGetFunctionsResp, _err error) {
	var _args73 TCLIServiceGetFunctionsArgs
	_args73.Req = req
	var _result75 TCLIServiceGetFunctionsResult
	var _meta74 thrift.ResponseMeta
	_meta74, _err = p.Client_().Call(ctx, "GetFunctions", &_args73, &_result75)
...
func (p *TCLIServiceClient) GetOperationStatus(ctx context.Context, req *TGetOperationStatusReq) (_r *TGetOperationStatusResp, _err error) {
	var _args76 TCLIServiceGetOperationStatusArgs
	_args76.Req = req
	var _result78 TCLIServiceGetOperationStatusResult
	var _meta77 thrift.ResponseMeta
	_meta77, _err = p.Client_().Call(ctx, "GetOperationStatus", &_args76, &_result78)
...
func (p *TCLIServiceClient) CancelOperation(ctx context.Context, req *TCancelOperationReq) (_r *TCancelOperationResp, _err error) {
	var _args79 TCLIServiceCancelOperationArgs
	_args79.Req = req
	var _result81 TCLIServiceCancelOperationResult
	var _meta80 thrift.ResponseMeta
	_meta80, _err = p.Client_().Call(ctx, "CancelOperation", &_args79, &_result81)
...
func (p *TCLIServiceClient) CloseOperation(ctx context.Context, req *TCloseOperationReq) (_r *TCloseOperationResp, _err error) {
	var _args82 TCLIServiceCloseOperationArgs
	_args82.Req = req
	var _result84 TCLIServiceCloseOperationResult
	var _meta83 thrift.ResponseMeta
	_meta83, _err = p.Client_().Call(ctx, "CloseOperation", &_args82, &_result84)
...
func (p *TCLIServiceClient) GetResultSetMetadata(ctx context.Context, req *TGetResultSetMetadataReq) (_r *TGetResultSetMetadataResp, _err error) {
	var _args85 TCLIServiceGetResultSetMetadataArgs
	_args85.Req = req
	var _result87 TCLIServiceGetResultSetMetadataResult
	var _meta86 thrift.ResponseMeta
	_meta86, _err = p.Client_().Call(ctx, "GetResultSetMetadata", &_args85, &_result87)
...
func (p *TCLIServiceClient) FetchResults(ctx context.Context, req *TFetchResultsReq) (_r *TFetchResultsResp, _err error) {
	var _args88 TCLIServiceFetchResultsArgs
	_args88.Req = req
	var _result90 TCLIServiceFetchResultsResult
	var _meta89 thrift.ResponseMeta
	_meta89, _err = p.Client_().Call(ctx, "FetchResults", &_args88, &_result90)
...
func NewTCLIServiceProcessor(handler TCLIService) *TCLIServiceProcessor {
	...
	self91 := &TCLIServiceProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self91.processorMap["OpenSession"] = &tCLIServiceProcessorOpenSession{handler: handler}
	self91.processorMap["CloseSession"] = &tCLIServiceProcessorCloseSession{handler: handler}
	self91.processorMap["GetInfo"] = &tCLIServiceProcessorGetInfo{handler: handler}
	self91.processorMap["ExecuteStatement"] = &tCLIServiceProcessorExecuteStatement{handler: handler}
	self91.processorMap["GetTypeInfo"] = &tCLIServiceProcessorGetTypeInfo{handler: handler}
	self91.processorMap["GetCatalogs"] = &tCLIServiceProcessorGetCatalogs{handler: handler}
	self91.processorMap["GetSchemas"] = &tCLIServiceProcessorGetSchemas{handler: handler}
	self91.processorMap["GetTables"] = &tCLIServiceProcessorGetTables{handler: handler}
	self91.processorMap["GetTableTypes"] = &tCLIServiceProcessorGetTableTypes{handler: handler}
	self91.processorMap["GetColumns"] = &tCLIServiceProcessorGetColumns{handler: handler}
	self91.processorMap["GetFunctions"] = &tCLIServiceProcessorGetFunctions{handler: handler}
	self91.processorMap["GetOperationStatus"] = &tCLIServiceProcessorGetOperationStatus{handler: handler}
	self91.processorMap["CancelOperation"] = &tCLIServiceProcessorCancelOperation{handler: handler}
	self91.processorMap["CloseOperation"] = &tCLIServiceProcessorCloseOperation{handler: handler}
	self91.processorMap["GetResultSetMetadata"] = &tCLIServiceProcessorGetResultSetMetadata{handler: handler}
	self91.processorMap["FetchResults"] = &tCLIServiceProcessorFetchResults{handler: handler}
	return self91
}
