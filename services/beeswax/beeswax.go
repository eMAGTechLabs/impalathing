...
import (
	...
	"github.com/eMAGTechLabs/impalathing/services/hive_metastore"
	"time"
)
...
func (p *BeeswaxServiceClient) ExecuteAndWait(ctx context.Context, query *Query, clientCtx LogContextId) (_r *QueryHandle, _err error) {
	var _args9 BeeswaxServiceExecuteAndWaitArgs
	_args9.Query = query
	_args9.ClientCtx = clientCtx
	var _result11 BeeswaxServiceExecuteAndWaitResult
	var _meta10 thrift.ResponseMeta
	_meta10, _err = p.Client_().Call(ctx, "executeAndWait", &_args9, &_result11)
...
func (p *BeeswaxServiceClient) Explain(ctx context.Context, query *Query) (_r *QueryExplanation, _err error) {
	var _args12 BeeswaxServiceExplainArgs
	_args12.Query = query
	var _result14 BeeswaxServiceExplainResult
	var _meta13 thrift.ResponseMeta
	_meta13, _err = p.Client_().Call(ctx, "explain", &_args12, &_result14)
...
func (p *BeeswaxServiceClient) Fetch(ctx context.Context, query_id *QueryHandle, start_over bool, fetch_size int32) (_r *Results, _err error) {
	var _args15 BeeswaxServiceFetchArgs
	_args15.QueryID = query_id
	_args15.StartOver = start_over
	_args15.FetchSize = fetch_size
	var _result17 BeeswaxServiceFetchResult
	var _meta16 thrift.ResponseMeta
	_meta16, _err = p.Client_().Call(ctx, "fetch", &_args15, &_result17)
	...
	case _result17.Error2 != nil:
		return _r, _result17.Error2
	}
...
func (p *BeeswaxServiceClient) GetState(ctx context.Context, handle *QueryHandle) (_r QueryState, _err error) {
	var _args18 BeeswaxServiceGetStateArgs
	_args18.Handle = handle
	var _result20 BeeswaxServiceGetStateResult
	var _meta19 thrift.ResponseMeta
	_meta19, _err = p.Client_().Call(ctx, "get_state", &_args18, &_result20)
...
func (p *BeeswaxServiceClient) GetResultsMetadata(ctx context.Context, handle *QueryHandle) (_r *ResultsMetadata, _err error) {
	var _args21 BeeswaxServiceGetResultsMetadataArgs
	_args21.Handle = handle
	var _result23 BeeswaxServiceGetResultsMetadataResult
	var _meta22 thrift.ResponseMeta
	_meta22, _err = p.Client_().Call(ctx, "get_results_metadata", &_args21, &_result23)
...
func (p *BeeswaxServiceClient) Echo(ctx context.Context, s string) (_r string, _err error) {
	var _args24 BeeswaxServiceEchoArgs
	_args24.S = s
	var _result26 BeeswaxServiceEchoResult
...
func (p *BeeswaxServiceClient) DumpConfig(ctx context.Context) (_r string, _err error) {
	var _args27 BeeswaxServiceDumpConfigArgs
	var _result29 BeeswaxServiceDumpConfigResult
	var _meta28 thrift.ResponseMeta
	_meta28, _err = p.Client_().Call(ctx, "dump_config", &_args27, &_result29)
...
func (p *BeeswaxServiceClient) GetLog(ctx context.Context, context LogContextId) (_r string, _err error) {
	var _args30 BeeswaxServiceGetLogArgs
	_args30.Context = context
	var _result32 BeeswaxServiceGetLogResult
	var _meta31 thrift.ResponseMeta
	_meta31, _err = p.Client_().Call(ctx, "get_log", &_args30, &_result32)
...
func (p *BeeswaxServiceClient) GetDefaultConfiguration(ctx context.Context, include_hadoop bool) (_r []*ConfigVariable, _err error) {
	var _args33 BeeswaxServiceGetDefaultConfigurationArgs
	_args33.IncludeHadoop = include_hadoop
	var _result35 BeeswaxServiceGetDefaultConfigurationResult
	var _meta34 thrift.ResponseMeta
	_meta34, _err = p.Client_().Call(ctx, "get_default_configuration", &_args33, &_result35)
...
func (p *BeeswaxServiceClient) Close(ctx context.Context, handle *QueryHandle) (_err error) {
	var _args36 BeeswaxServiceCloseArgs
	_args36.Handle = handle
	var _result38 BeeswaxServiceCloseResult
	var _meta37 thrift.ResponseMeta
	_meta37, _err = p.Client_().Call(ctx, "close", &_args36, &_result38)
	...
	case _result38.Error != nil:
		return _result38.Error
	case _result38.Error2 != nil:
		return _result38.Error2
	}
...
func (p *BeeswaxServiceClient) Clean(ctx context.Context, log_context LogContextId) (_err error) {
	var _args39 BeeswaxServiceCleanArgs
	_args39.LogContext = log_context
	var _result41 BeeswaxServiceCleanResult
	var _meta40 thrift.ResponseMeta
	_meta40, _err = p.Client_().Call(ctx, "clean", &_args39, &_result41)
...
func NewBeeswaxServiceProcessor(handler BeeswaxService) *BeeswaxServiceProcessor {
	...
	self42 := &BeeswaxServiceProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self42.processorMap["query"] = &beeswaxServiceProcessorQuery{handler: handler}
	self42.processorMap["executeAndWait"] = &beeswaxServiceProcessorExecuteAndWait{handler: handler}
	self42.processorMap["explain"] = &beeswaxServiceProcessorExplain{handler: handler}
	self42.processorMap["fetch"] = &beeswaxServiceProcessorFetch{handler: handler}
	self42.processorMap["get_state"] = &beeswaxServiceProcessorGetState{handler: handler}
	self42.processorMap["get_results_metadata"] = &beeswaxServiceProcessorGetResultsMetadata{handler: handler}
	self42.processorMap["echo"] = &beeswaxServiceProcessorEcho{handler: handler}
	self42.processorMap["dump_config"] = &beeswaxServiceProcessorDumpConfig{handler: handler}
	self42.processorMap["get_log"] = &beeswaxServiceProcessorGetLog{handler: handler}
	self42.processorMap["get_default_configuration"] = &beeswaxServiceProcessorGetDefaultConfiguration{handler: handler}
	self42.processorMap["close"] = &beeswaxServiceProcessorClose{handler: handler}
	self42.processorMap["clean"] = &beeswaxServiceProcessorClean{handler: handler}
	return self42
}
